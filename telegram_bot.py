...
<b>ℹ️ основные команды:
/card - получить карточку
/stats - посмотреть свою статистику
/nick - установить никнейм

⛓ полезные ссылки:
t.me/UFCards - официальный канал бота
t.me/UFCtexBot - техподдержка

🧠 система карточек:
• карточку можно получить раз в 3 часа, используя команду /card или написав слово «карта»
• существует 3 крутости - обычная, жоская и ИМБОВАЯ
• за получение карточки начисляются UFCoins, но открытие нового бойца приносит в 2 раза больше, чем повторки</b>"""
